namespace DominoPlayer
{
    public struct Move
    {
        ...
        public static Move CreateMove(int playerID, Piece piece, bool right) => new Move(playerID, piece, false, right);
        public static Move CreatePass(int playerID) => new Move(playerID, default, true, default);
    }
}